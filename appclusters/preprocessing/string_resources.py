...
from appclusters.util.strings import is_camel_case, camel_case_split, remove_non_printable, \
    remove_numbers, is_url, contains_whitespace, is_java_package
...
def preprocess():
    stringres_folder = '/workstore/sgruber/app_properties/raw/run4/stringres/'
...
def test():
    ...
    for file in files:
        a = APKStringResources(file=os.path.join(stringres_folder, file))#"/workstore/sgruber/app_properties/raw/run4/stringres/org.telegram.messenger.pk")
